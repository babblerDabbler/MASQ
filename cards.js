...
export const cardSets = [
  {
    ...
    cards: [
            ...
            { id: 67, name: "Node Librarian", cost: 2, attack: 2, health: 3, ability: "Draw 2 cards. If both are unique types, gain +1 mana next turn.", texture: "/cards/a67.webp", weight: 3, lore: "Curates the knowledge of every node, connecting ideas across fractured data streams." },
